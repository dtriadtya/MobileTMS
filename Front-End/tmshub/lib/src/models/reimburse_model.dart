...
class ReimburseModel {
  ...
  factory ReimburseModel.fromJson(Map<String, dynamic> json) => ReimburseModel(
        ...
        idUser: json["id_user"],
        tanggalReimburse: json["tanggal_reimburse"] == null
            ? null
            : DateTime.parse(json["tanggal_reimburse"]),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "id_user": idUser,
        "tanggal_reimburse": tanggalReimburse != null
            ? DateFormat("dd-MM-yyyy").format(tanggalReimburse!)
            : null,
